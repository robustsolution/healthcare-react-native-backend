...
case ${APP_ENV} in
    prod)
        ...
        gunicorn --timeout 6000 --access-logfile - --error-logfile - --log-level debug -w 4 -k gevent -b 0.0.0.0:8080 app:app
        ;;
    dev_docker)
    ...
    stg)
        ...
        ;;
    *)
        gunicorn --timeout 6000 --access-logfile - --error-logfile - --log-level debug -w 2 -k gevent -b 0.0.0.0:8080 app:app
        ;;
esac
